...
#   plot-vcfstats -p vcfstats/AJtrio.trioscompass vcfstats/AJtrio.trioscompass.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. AJtri .. output/dnm_vcf/AJtrio.dnm.vcf
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='AJtri')
    has_data = 1
